	...
	try {
			...
			while(result.next())
			{
				...
				profiles+=" <div class=\"panel panel-primary\"><div class=\"panel-heading\">"+result3.getString("restaurant_name")+"</div>"+
			     ...
			     +result.getString("REVIEW_DES")+"</p><div class=\"col-xs-12 col-md-6\"><a class=\"btn btn-primary\" href=\"EditReview?restaurant="+result.getString("restaurant_id")+"\"> Edit Review </a></div></div></div>";
